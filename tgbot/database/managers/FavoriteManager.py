...
class FavoriteManager:
    @classmethod
    async def create_favorite(cls, favorite_data: FavoriteSchema):
    ...
    @classmethod
    async def get_user_favorites(cls, user_id: str) -> List[FavoriteSchema]:
        async with AsyncSessionLocal() as session:
    ...
    @overload
    @classmethod
    async def delete_favorite(cls, user_id: None, resource_id: None, favorite_id: UUID4) -> None: ...

    @overload
    @classmethod
    async def delete_favorite(cls, user_id: str, resource_id: UUID4, favorite_id: None = None) -> None: ...

    @classmethod
    async def delete_favorite(cls, user_id = None, resource_id = None, favorite_id = None):
        async with AsyncSessionLocal() as session:
            if favorite_id:
