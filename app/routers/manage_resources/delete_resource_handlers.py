...
from constants import DELETE_RESOURCE_CATEGORIES_ON_PAGE
...
async def delete_resource_callback_handler(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.answer(
        text=t(
            "manage_resources.delete.choose_category",
...
async def delete_resource_category_select(
    ...
    await callback.message.answer(
        text=t(
            "manage_resources.delete.choose_resource",
            callback.from_user.language_code,
        ),
...
async def delete_resource_select(
    ...
    await callback.message.answer(
        ...
        reply_markup=manage_resources_delete_keyboard_confirm(
            callback.from_user.language_code,
        ),
    )
