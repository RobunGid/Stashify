...
from application.formatters.resource_item import ResourceItemFormatter
...
async def category_resources_list_page(
    ...
    with_quiz_item = None
    if callback_data.context in ("crt_quiz_qst", "dlt_quiz", "dlt_quiz_qst"):
        with_quiz_item = True
    if callback_data.context in ("crt_quiz"):
        with_quiz_item = False
...
async def list_resource_resource_select(
    ...
    resource_item_formatter: FromDishka[ResourceItemFormatter],
    ...
    await callback.message.answer(
        text=resource_item_formatter.format_resource_item(
