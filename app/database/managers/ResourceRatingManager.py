...
from schemas.resource_rating_schema import (
...
class ResourceRatingManager:
    ...
    async def create(
        cls,
        resource_rating_data: ResourceRatingWithoutUserAndResourceSchema,
    ):
    ...
    async def get_one(
        ...
        async with AsyncSessionLocal() as session:
            ...
            statement = (
                ...
                .options(
                    selectinload(ResourceRatingModel.user).selectinload(
            ...
            if resource_rating is None:
                return None
            return ResourceRatingSchema.model_validate(
                resource_rating,
